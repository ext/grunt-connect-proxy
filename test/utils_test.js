...
exports.utils_test = {
    ...
    match_context_test: function(test) {
        ...
        test.equal(
            match,
            true,
            "should match single context with matching start"
        );
        ...
        test.equal(
            match,
            false,
            "should not match single context with different start"
        );
        ...
        test.equal(
            match,
            true,
            "should match array context with matching start"
        );
        ...
        test.equal(
            match,
            true,
            "should match array context with matching start if same pattern is found later"
        );
        ...
        test.equal(
            match,
            false,
            "should not match array context with negative context"
        );
        ...
        test.equal(
            match,
            true,
            "should match array context with different negative context"
        );
